<?
	...
	if($count> 0) echo "<script>alert('삭제되었습니다.'); window.location.href='order_list.php';</script>";
	else  echo "<script>alert('삭제 실패.'); window.location.href='order_list.php';</script>";
